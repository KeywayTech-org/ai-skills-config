...
Use `clip-path: inset()` to reveal a destructive action progressively as the user holds a button. Combined with scale-on-press, this creates a satisfying "charging" interaction.
